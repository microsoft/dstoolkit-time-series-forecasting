...
# MAGIC %md
# MAGIC # Create Configuration File - Rolling Mean Example
# MAGIC 
...
manager = ConfigManager(path_to_config="./json/rolling_mean_config_small.json")
rm_config = manager.get()
pprint(rm_config)
...
# MAGIC     },
# MAGIC },
# MAGIC "feature_engineering": For rolling mean, this is not applicable.
...
filename_prefix = f'config_{rm_config["model_params"]["model_name_prefix"]}'
...
# Save Config to DBFS:
manager.save(config=rm_config, path_to_save=filepath_to_save)
